...
from dpr.options import add_encoder_params, add_main_params, setup_args_gpu, print_args, set_encoder_params_from_state, \
...
if __name__ == '__main__':
    ...
    add_main_params(parser)
    
    parser.add_argument('--qa_file', type=str, default="/home/eoincmcc/CORA/data/xor_dev_full_v1_1.jsonl",
                        help="Question and answers file of the format: question \\t ['answer1','answer2', ...]")
    parser.add_argument('--ctx_file', type=str, default="/home/eoincmcc/CORA/models/all_w100.tsv",
                        help="All passages file in the tsv format: id \\t passage_text \\t title")
    parser.add_argument('--encoded_ctx_file', type=str, default='/home/eoincmcc/CORA/models/embeddings/wiki_emb_*',
    ...
    args.model_file = "/home/eoincmcc/CORA/models/mDPR_biencoder_best.cpt"
